...
import InterconnectionVenuesDarkFiber from '../../components/companies/menus/services/connectivity/InterconnectionVenuesDarkFiber/InterconnectionVenuesDarkFiber'

import Footer from '../../components/companies/footer/Footer'

export default function PageWorkWithus() {
  return (
    <div class="wrapper">
      <Header/>
      <InterconnectionVenuesDarkFiber/>
      <Footer/>
