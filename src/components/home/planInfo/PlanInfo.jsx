    ...
    <div className="planInfo">
      <div className="plan-info-column">
        <div className="plan-info-text-wrapper">
          <h1 className="headingChooseUs">¿Por qué Internet de Fiber Peru?</h1>
          ...
          <div className="itemChooseUs">
            <div className="itemTitleChooseUs">Sin límites de datos</div>
            <div className="itemDescriptionChooseUs">
              Disfruta de la diversión sin fin en línea. Con datos mensuales
              ilimitados, puede conectarse todo lo que quiera, cuando quiera,
