    ...
    >
      ...
      >
        ...
        >
          <Tab
            label="Bancos"
            icon={<img src={IconBanco} height={65} width={55} />}
            {...a11yProps(0)}
            sx={{ padding: '50px' }}
          />
          <Tab
            icon={<img src={IconAgente} height={65} width={85} />}
            label="Agentes"
            {...a11yProps(1)}
            sx={{ padding: '50px' }}
          />
          <Tab
            icon={<img src={IconOnline} height={65} width={85} />}
            label="En linea"
            {...a11yProps(2)}
            sx={{ padding: '50px' }}
          />
          <Tab
            icon={<img src={IconYape} height={55} width={55} />}
            {...a11yProps(3)}
            sx={{ padding: '50px' }}
          />
        </Tabs>
