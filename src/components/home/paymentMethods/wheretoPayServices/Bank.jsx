    ...
    >
      ...
      >
        ...
        >
          {' '}
          {'\n'}
          &#8226; Acércate a ventanilla e indica que deseas realizar el pago de
          tu servicio de Internet fiber-peru.
        </Typography>
        <Typography variant="h8" sx={{ color: '#301d19', fontWeight: '500' }}>
          &#8226; Brinda tu código de pago, ubicado en la parte superior derecha
          de tu recibo (no consideres los 00 de la izquierda)
        </Typography>
      </Box>
      <Box
        sx={{
      ...
      >
        <img className="bank-img" src={IconBancos} alt={''} />
      </Box>
      ...
      >
        ...
        >
          <img className="" src={IconBcp} width="70px" />
          <Typography
            variant="h8"
            sx={{
              color: '#9CA3AF',
        ...
        >
          <img className="" src={IconScotiabank} width="100px" />
          <Typography
            variant="h8"
            sx={{
              color: '#9CA3AF',
        ...
        >
          <img className="" src={IconInterbank} width="90px" />
          <Typography
            variant="h8"
            sx={{
              color: '#9CA3AF',
