    ...
    >
      ...
      >
        ...
        >
          {' '}
          {'\n'}
          &#8226; Puedes realizar el pago de tus recibos en los agentes
          Interbank, BCP, BBVA y Scotiabank.
        </Typography>
        <Typography variant="h8" sx={{ color: '#301d19', fontWeight: '500' }}>
          &#8226; También puedes pagar en los establecimientos de Tambo
          (Efectivo y tarjeta BBVA), KasNet (Efectivo y tarjeta Scotiabank) y
          Western Union.
        </Typography>
      </Box>
