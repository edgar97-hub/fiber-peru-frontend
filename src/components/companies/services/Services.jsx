    ...
    <div id="companies-services">
      ...
      <div className="plan-benefits-box">
        <img className="serviceImg"
          src={"https://raw.githubusercontent.com/JulianLaval/canvas-particle-network/master/img/demo-bg.jpg"}/>
      ...
      <div className="plan-benefits-box">
        ...
        <h2 className="title">Telefonia corporativa y comunicaciones unificadas</h2>
